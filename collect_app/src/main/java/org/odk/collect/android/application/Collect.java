...
public class Collect {
    ...
    public void init(Application application, Context context, FormManagmentModuleInitialisationListener informer) {
        if(application != null && context != null) {
            ...
            PreferenceManager.getDefaultSharedPreferences(appContext).edit().putString(GeneralKeys.KEY_APP_LANGUAGE, PreferenceManager.getDefaultSharedPreferences(appContext).getString(Constants.APP_LANGUAGE_KEY, "en")).apply();
