...
public class assessmentAnnouncementtest {

    @Rule
    public ActivityTestRule<HomeActivity> mActivityTestRule = new ActivityTestRule<>(HomeActivity.class);

    @Test
    public void assessmentAnnouncementtest(){
       ...
       /* //Snackbar
        ...
        checkRenderDisplaywithText("FA1",R.id.select_container,"android.widget.LinearLayout",0,0);
        onView(isRoot()).perform(waitFor(2000));

        checkRenderwaitForTextInputDisplayed(R.id.simple_button,0);
        onView(isRoot()).perform(waitFor(2000));

        checkRenderButtonDisplayandClick(android.R.id.button1,"ओके","android.widget.ScrollView",0,3);
        onView(isRoot()).perform(waitFor(1000));
