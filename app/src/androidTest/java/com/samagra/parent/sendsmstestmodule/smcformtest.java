...
public class smcformtest {

    @Rule
    public ActivityTestRule<HomeActivity> mActivityTestRule = new ActivityTestRule<>(HomeActivity.class);
    @Test
    public void smcformtest() {
        ...
        checkRenderDisplaywithText("एसएमसी सभा (SMC meeting)",R.id.select_container,"android.widget.LinearLayout",0,0);
        onView(isRoot()).perform(waitFor(2000));
